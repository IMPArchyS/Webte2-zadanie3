...
export function startGame(username, ws, userColor) {
    const nameSpan = document.getElementById('aliasGame');
    ...
    let sketch = (level) => {
        ...
        level.drawPlayer = () => {
            level.fill(playerColor.r, playerColor.g, playerColor.b);
            ...
            for (let i = 0; i < numColumns; i++) {
                for (let j = 0; j < numRows; j++) {
                    ...
                    if (square.fresh && !square.claimed) {
                        level.fill(playerColor.r, playerColor.g, playerColor.b, 150);
                        level.rect(square.posX, square.posY, gridSize, gridSize);
                    } else if (square.claimed) {
                        level.fill(playerColor.r - 20, playerColor.g - 20, playerColor.b - 20);
                        level.rect(square.posX, square.posY, gridSize, gridSize);
                    }
                }
            }
